<template>
  <label role="checkbox" :class="className" :aria-checked="ariaChecked">
    <input type="checkbox" class="v-switch-input" :name="name" @change.stop="toggle">
    <div class="v-switch-core" :style="coreStyle">
      <div class="v-switch-button" :style="buttonStyle" />
    </div>
    <template v-if="labels">
      <span class="v-switch-label v-left" :style="labelStyle" v-if="toggled" v-html="labelChecked" />
      <span class="v-switch-label v-right" :style="labelStyle" v-else v-html="labelUnchecked" />
    </template>
  </label>
</template>

<script>
// copied from vue-js-toggle-button package
